 ...
 * Slug: blockskit-blog/template-order-confirmation
 * Categories: template
 * Inserter: false
 */
...
<h1 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Order Confirmation', 'blockskit-blog' ); ?></h1>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading" style="font-size:24px"><?php esc_html_e( 'Order details', 'blockskit-blog' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"24px"}}} -->
<h3 class="wp-block-heading" style="font-size:24px"><?php esc_html_e( 'Downloads', 'blockskit-blog' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"24px"}}} -->
<h3 class="wp-block-heading" style="font-size:24px"><?php esc_html_e( 'Shipping address', 'blockskit-blog' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"24px"}}} -->
<h3 class="wp-block-heading" style="font-size:24px"><?php esc_html_e( 'Billing address', 'blockskit-blog' ); ?></h3>
<!-- /wp:heading -->
