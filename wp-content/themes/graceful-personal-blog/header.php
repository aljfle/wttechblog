...
<body <?php body_class(); ?>>
	...
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'graceful-personal-blog' ); ?></a>	
	...
	<div id="site-container">
		...
		<?php
			if ( is_home() && !is_paged() ) {
			    ...
			    // Show Hero Banner if enabled
			    $graceful_hero_banner_enabled = graceful_personal_blog_options('hero_banner_show');
			    if ( $graceful_hero_banner_enabled ) {
			    ...
			    $graceful_featured_boxes_enabled = graceful_personal_blog_options('featured_boxes_show');
